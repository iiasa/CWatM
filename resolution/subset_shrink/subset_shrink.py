...
print('Converting to a resolution of ' + str(reso) + ' degrees.')
...
def loadnetcdfSubset():
    ...
    """
    print('latl '+str(latl) + ', latli '+str(latli))
    print('latu ' + str(latu) + ', latui '+str(latui))
    print('lonl ' + str(lonl) + ', lonli '+str(lonli))
    print('lonu ' + str(lonu) + ', lonui '+str(lonui))
...
def outputnetcdf(netfile, srclist):
    ...
    latitudes = np.arange(latu - reso/2 + original_reso/2, latl + original_reso/2, -reso)
    longitudes = np.arange(lonl + reso/2 - original_reso/2, lonu - original_reso/2, reso)
