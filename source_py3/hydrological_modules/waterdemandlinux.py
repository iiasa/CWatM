        ...
        if checkOption('includeWaterDemand'):
            ...
            if self.var.uselivestock:
                ...
                if dateVar['newStart'] or dateVar[new]:
                    ...
                    # avoid small values (less than 1 m3):
                    self.var.livestockDemand = 40 * np.where(self.var.livestockDemand > self.var.InvCellArea, self.var.livestockDemand, 0.0)
                    self.var.livestockDemand3 = self.var.livestockDemand / dateVar['daysInMonth']
                    ...
                    #self.var.livestockDemand2 = self.var.livestockDemand.copy()
                    if not (self.var.demand_unit):
