...
class ConvertMapsToNetCDF4():
    def __init__(self, attribute=None):
        ...
        self.latitudes = np.arange(lat1, 48.0, -reso)
        self.longitudes = np.arange(lon1, 18.5, reso)
...
inDir = "./"
inName1 = inDir+"ksat_3_1min2.tif"
outDir = "./"
netcdfOut = outDir + "ksat_3_1min2.nc"
timeattr = False

varShortNames = ['ksat2']
varLongNames = ['saturated soil conditivity layer2 multiplied with 2']
